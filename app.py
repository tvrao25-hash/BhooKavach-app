...
MASTER_DATA_MATRIX = {
    ...
    "Dubai Cross-Border Window (U.A.E.)": [
        ...
        {"name": "Al-Amal Fractional Tower", "builder": "Gulf Horizon Realty", "zone": "Jumeirah Village Circle", "rera": "DLD-EXPIRED-992", "auth": "Dubai Land Dept", "status": "ESCROW FREEZE / DEFAULT", "floors": 40, "grade": "F"}
    ]
}
...
# ==========================================
st.markdown("<div style='font-size: 1.1rem; font-weight: 700; color: #0F4A28; margin-bottom: 15px;'>🛡️ PILLAR 1 VERIFICATION MODULE INTERFACE</div>", unsafe_allow_html=True)

ctrl_side, terminal_side = st.columns([1.1, 1.9])

with ctrl_side:
    st.markdown("<div class='control-panel'>", unsafe_allow_html=True)
    st.markdown("<div class='panel-header'>⚙️ Audit Control Parameters</div>", unsafe_allow_html=True)
    
    region_selection = st.selectbox("Select Target Regional Database Matrix:", list(MASTER_DATA_MATRIX.keys()))
